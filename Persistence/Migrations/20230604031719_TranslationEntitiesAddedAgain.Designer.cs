...
namespace Persistence.Migrations
{
    ...
    [Migration("20230604031719_TranslationEntitiesAddedAgain")]
    partial class TranslationEntitiesAddedAgain
    {
            ...
            modelBuilder.Entity("Domain.Complaints.TranslatedComplaint", b =>
                {
                    ...
                    b.ToTable("TranslatedComplaintsHindi", (string)null);

                    b.HasDiscriminator<int>("Language").HasValue(1);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "057454b3-023a-4749-80ad-a43cfde2862c",
                            ConcurrencyStamp = "ac09b72f-ff14-49b4-b462-70651821ee00",
                            Name = "Member",
                            NormalizedName = "MEMBER"
                        },
                        new
                        {
                            Id = "8b6f67d6-4ab3-4113-aea5-840aae4eb065",
                            ConcurrencyStamp = "ef413459-b52b-4303-81e1-cb4714dc7f18",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Domain.Complaints.TranslatedComplaint", b =>
                {
                    ...
                    b.HasOne("Domain.Complaint", null)
                        .WithOne("TranslatedComplaint")
                        .HasForeignKey("Domain.Complaints.TranslatedComplaint", "ComplaintId1");
