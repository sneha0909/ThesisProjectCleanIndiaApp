...
namespace Persistence.Migrations
{
    ...
    [Migration("20230603052539_RemovedCircularReferenceIssue")]
    partial class RemovedCircularReferenceIssue
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7c0e39a7-344d-4001-99f3-752c13000090",
                            ConcurrencyStamp = "f78081fc-9706-4932-907d-91749a2814b5",
                            Name = "Member",
                            NormalizedName = "MEMBER"
                        },
                        new
                        {
                            Id = "dda78bbc-885d-4bfe-b6bf-0efb06ee3d05",
                            ConcurrencyStamp = "bf9f98f6-31a3-435f-ac10-5c42b2e3e945",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Domain.Complaint", b =>
                {
                    ...
                    b.HasOne("Domain.Feedback", "Feedback")
                        .WithOne()
                        .HasForeignKey("Domain.Complaint", "FeedbackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
