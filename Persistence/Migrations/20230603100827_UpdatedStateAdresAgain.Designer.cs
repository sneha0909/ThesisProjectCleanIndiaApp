...
namespace Persistence.Migrations
{
    ...
    [Migration("20230603100827_UpdatedStateAdresAgain")]
    partial class UpdatedStateAdresAgain
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6e01dad2-e33f-4c4c-806a-843551354646",
                            ConcurrencyStamp = "ac108422-4c33-492c-933a-d71625a3a0cc",
                            Name = "Member",
                            NormalizedName = "MEMBER"
                        },
                        new
                        {
                            Id = "9eff2099-feec-4776-8749-b2d543ca6f00",
                            ConcurrencyStamp = "73b3c53d-991d-4533-a40b-92f7beaddbaa",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Domain.Complaints.State", b =>
                {
                    b.HasOne("Domain.Complaints.Address", "Address")
                        .WithOne()
                        .HasForeignKey("Domain.Complaints.State", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
