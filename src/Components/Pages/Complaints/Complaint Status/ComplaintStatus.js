...
import '../Complaint Status/ComplaintStatus.css';
    ...
    const handleSubmit = (event) => {
        ...
        if (search === "searchbyComplaintNo") {
            if (ComplaintNo.length === 0) {
                ...
                navigate("/SearchResultsByComplaintNumber/" + ComplaintNo);
        ...
        if (search === "SearchbyComplaintDetails") {
            if (ComplaintType.length === 0 || ComplainantName.length === 0 || Mobile.length === 0) {
                ...
                navigate("/SearchResultsByDetails/" + ComplaintType + "/" + ComplainantName + "/" + Mobile);
