...
import '../Admin/ComplaintDetail.css';
import { Button } from 'semantic-ui-react';


const ComplaintNumberSearchResults = () => {
            ...
            <form id="DetailsComplaints">
                ...
                <div className="ComplaintD">
                    ...
                    <div className='ComplaintInfoPart1'>
                        ...
                        <br></br>
                        <label htmlFor='' id='LabelId'>Photo: <img src={empdata.photoUrl} width="200px" height="200px" alt="" /></label>
...
export default ComplaintNumberSearchResults;