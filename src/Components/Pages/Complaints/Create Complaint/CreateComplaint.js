        ...
        <form>
          ...
          <div className='HiddenComplaintForm'>
            ...
            <div className='ComplaintFormPart3'>
              ...
              <span id='RequiredMark'>*</span>
              <label htmlFor="HouseNo" id='LabelMargin'>{t('House No.:')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="HouseName" id='LabelMargin'>{t('House Name')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="AreaInAddress" id='LabelMargin'>{t('Area in Address')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="ZoneWardNo" id='LabelMargin'>{t('ZoneNumWardNum')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="Area1" id='LabelMargin'>{t('Area 1')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="Area2" id='LabelMargin'>{t('Area 2')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="City" id='LabelMargin'>{t('City')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="Pincode" id='LabelMargin'>{t('Pincode')}</label>
            ...
            <div className='ComplaintFormPart4'>
              ...
              <span id='RequiredMark'>*</span>
              <label htmlFor="CName" id='LabelMargin'>{t('Complainant Name')}</label>
            ...
            <div className='ComplaintFormPart5'>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="HouseNum" id='LabelMargin'>{t('House No.:')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="AreaInAdd" id='LabelMargin'>{t('Area in Address')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="ZoneWardNum" id='LabelMargin'>{t('ZoneNumWardNum')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="Ar1" id='LabelMargin'>{t('Area 1')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="Ar2" id='LabelMargin'>{t('Area 2')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="LandMark" id='LabelMargin'>{t('LandMark')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="State" id='LabelMargin'>{t('State')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="Country" id='LabelMargin'>{t('Country')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="STDCodeOffice" id='LabelMargin'>{t('(STD Code)')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="TelephoneOffice" id='LabelMargin'>{t('Telephone (Off.)')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="STDCodeResidence" id='LabelMargin'>{t('(STD Code)')}</label>
              <input value={complainantAddressSTDCodeResidenceTelephone} onChange={(e) => setComplainantAddressSTDCodeResidenceTelephone(e.target.value)} type="text" name="STDCodeResidence" id='ComplaintInput'></input>
              {
                error && complainantAddressSTDCodeResidenceTelephone.length <= 0 ? <label id='ComplaintFieldEmptyError'>* Field required!</label> : ""
              }
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="TelephoneResidence" id='LabelMargin'>{t('Telephone (Res.)')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="MobileNumber" id='LabelMargin'>{t('MobileNo')}</label>
              ...
              <br></br>
              <span id='RequiredMark'>*</span>
              <label htmlFor="EMailAddress" id='LabelMargin'>{t('E-Mail Address')}</label>
